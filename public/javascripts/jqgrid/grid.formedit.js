...
$.fn.extend({
	...
	navGrid : function (elem, o, pEdit,pAdd,pDel,pSearch) {
		...
		return this.each(function() {       
			...
			$("tr td#"+pgid+"_"+o.position,"#"+pgid).width(500);
			var tbw = $("tr td#"+pgid+"_"+o.position+ " > table.navtable","#"+pgid).width();
			if(tdwidth > tbw) {
				$("#"+pgid+"_"+o.position,"#"+pgid).width(tdwidth);
			} else {
				$("#"+pgid+"_"+o.position,"#"+pgid).width(tbw+8);
			}
		});
	},
	navButtonAdd : function (elem, p) {
		...
		return this.each(function() {
			...
			if (findnav) {
				...
				var tdfnw = $(findnav).parent().width();
				$(findnav).parent().width(tdfnw+50);
				var fnvw = $(findnav).width();
				if(tdfnw > fnvw) {
					$(findnav).parent().width(tdfnw);
				} else {
